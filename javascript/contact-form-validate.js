	...
	$('form#contact-form').submit(function() {
		...
		if(!hasError) {
			...
			$.post($(this).attr('action'),formInput, function(data){
				$("form#contact-form").before('<div class="contact-success"><strong>¡MENSAJE ENVIADO!</strong><p>Su mensaje ha sido enviado correctamente. Nos pondremos en contacto con usted lo antes posible.</p></div>');
			});
		}

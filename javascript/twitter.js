...
(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      auto_join_text_default: "he dicho,",      // [string]   auto text for non verb: "i said" bullocks
      auto_join_text_ed: "yo",                  // [string]   auto text for past tense: "i" surfed
      auto_join_text_ing: "he estado",          // [string]   auto tense for present tense: "i was" surfing
      auto_join_text_reply: "he contestado a",  // [string]   auto tense for replies: "i replied to" @someone "with"
      auto_join_text_url: "estaba mirando",     // [string]   auto tense for urls: "i was looking at" http:...
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.results || data, function(item){
            ...
            var time = '<span class="tweet_time"><a href="'+tweet_url+'" title="ver tweet en twitter">'+tweet_relative_time+'</a></span>';
